<template>
    <section class="about-section" ref="aboutSection">
      <div class="about-overlay" :class="{ visible: showContent }">
          ...
          <div class="about-card">
            ...
            <div class="about-text">
              ...
              <p class="intro">
                ...
                <span class="highlight">aarnoor Singh</span> is not just a developer — he's a <strong>bridge between aesthetic and logic</strong>.
              </p>
              <p class="story">
  ...
  <style scoped>
  @import url('https://fonts.googleapis.com/css2?family=Bold+Apex&display=swap');
  ...
  .about-overlay {
    ...
    background: #111;
    border-radius: 28px;
    box-shadow: 0 0 30px rgba(0, 255, 242, 0.06);
    overflow: hidden;
  }
  ...
  .about-image {
    ...
    align-items: center;
    position: relative;
    background: #111; /* Background color for the image */
    border-radius: 10px;
    overflow: hidden;
  }
  ...
  .image-background {
    width: 100%;
    padding-top: 177.78%; /* To maintain 9:16 aspect ratio (16/9 = 1.7778) */
    position: relative;
  }
